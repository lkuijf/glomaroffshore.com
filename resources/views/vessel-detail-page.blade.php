...
<div class="vesselDetailPageTextWrap">
    <div class="inner">
        ...
        <div class="vesselButtons">
            ...
            <p><a href="tel:{{ Str::replace(' ', '', $data['website_options']->phone_number) }}" target="_blank" class="ctaBtn btnTransparent btnIconPhone">{{ $data['website_options']->phone_number }}</a></p>
        </div>
        @endif
    </div>
</div>
