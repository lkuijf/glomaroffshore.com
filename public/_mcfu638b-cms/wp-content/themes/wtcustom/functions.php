...
$websiteOptions[] = array('text', 'linkedin', 'LinkedIn link ' . __( 'News' ) . ' ' . __( 'Page' ) . ' ' . __( 'Something we dont know' ) . ' ' . _e( 'Some other meaningless string' ));
$websiteOptions[] = array('text', 'twitter', 'Twitter link' . ' ' . __( 'Twitter somehow' ));
