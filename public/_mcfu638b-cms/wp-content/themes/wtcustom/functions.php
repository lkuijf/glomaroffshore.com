...
$websiteOptions[] = array('text', 'linkedin', 'LinkedIn link ' . __( 'News' ) . ' ' . __( 'Page' ) . ' ' . __( 'Something we dont know', 'wtlocale' ) . ' ' . _e( 'Some other meaningless string', 'wtlocale' ));
$websiteOptions[] = array('text', 'twitter', 'Twitter link' . ' ' . __( 'Twitter somehow 1', 'wtlocale' ) . ' ' . _e( 'Twitter somehow 2', 'wtlocale' ));
