...
$websiteOptions[] = array('text', 'linkedin', 'LinkedIn link ' . __( 'News' ) . ' ' . __( 'Page' ) . ' ' . __( 'Something we dont know', 'wt_locale' ) . ' ' . _e( 'Some other meaningless string', 'wt_locale' ));
$websiteOptions[] = array('text', 'twitter', 'Twitter link' . ' ' . __( 'Twitter somehow', 'wt_locale' ));
